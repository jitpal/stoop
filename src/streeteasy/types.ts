/**
 * Raw StreetEasy GraphQL shapes, adapted from evandcoleman/streeteasy-api (MIT)
 * via Alec2435/streeteasy-mcp (MIT). Only the fields the queries ask for.
 */

/** A StreetEasy area code (see src/data/areas.json). */
export type AreaCode = number;
/** A StreetEasy amenity enum token (see src/streeteasy/amenities.ts). */
...
export type Available = { startDate: string; endDate: null } | { startDate: null; endDate: string };
