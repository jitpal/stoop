 ...
 * `Authorization: Bearer stoop_...`. This module owns the second one's format and
 * its hash; the keys themselves live (hashed) in the `StoopStore` Durable Object,
 * and `src/auth/guard.ts` is what looks them up.
 *
 ...
 */
export const API_KEY_PREFIX = "stoop_";
